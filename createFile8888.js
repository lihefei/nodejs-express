...
app.get('/api/createFile', function(req, res) {
    ...
    var name = req.query.name || 'unnamed';
    var suffix = req.query.suffix || 'txt';
    var fullName = 'data/' + name + '.' + suffix;
    var content = req.query.content || 'hello world!';
...
app.post('/api/createFile', function(req, res) {
    ...
    var name = req.body.name || 'unnamed';
    var suffix = req.body.suffix || 'txt';
    var fullName = 'data/' + name + '.' + suffix;
    var content = req.body.content || 'hello world!';
